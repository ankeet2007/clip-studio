              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] font-mono uppercase tracking-wider text-muted-foreground mb-0.5">Source</p>
                    {clip.sourceType === "local" ? (
                      <p className="text-sm font-mono break-all">
                        <span className="text-primary/70 font-semibold mr-1">LOCAL</span>
                        {clip.localFileName ?? "Uploaded file"}
                      </p>
                    ) : (
