  ...
  return {
    ...
    async configureServer(viteServer) {
      ...
      viteServer.middlewares.use((req, res, next) => {
        ...
        // Only intercept requests that could relate to mockup files —
        // patching res.end on every asset/chunk request is unnecessary overhead.
        if (!shouldAutoRescan(pathname)) {
          next();
          return;
        }
